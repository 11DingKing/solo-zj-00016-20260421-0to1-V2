      ...
      <section class="bg-white rounded-2xl shadow-lg p-6">
        ...
        <div v-else class="space-y-4">
          <div
            ...
            :key="link.short_code"
            class="border border-gray-200 rounded-xl p-4 hover:border-indigo-300 hover:shadow-md transition overflow-hidden"
          >
            <div
            ...
            >
              <div class="flex-1 min-w-0">
                ...
                <div
                  class="flex items-center flex-wrap gap-4 mt-2 text-xs text-gray-400"
                >
    ...
    case "custom":
      if (customExpiry.value) {
        return {
          ...
          expires_at: new Date(customExpiry.value),
        };
      }
...
const loadUserLinks = async () => {
  ...
  try {
    const response = await fetch(
      `${apiBase}/api/links?page=${currentPage.value}&page_size=${pageSize.value}`,
      {
        credentials: "include",
      },
    );
